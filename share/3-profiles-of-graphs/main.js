...
function setupControls() {
  ...
  function buildRestrictionRows() {
    ...
    restrictions.forEach((r, i) => {
      ...
      const dec = document.createElement('button'); dec.type = 'button'; dec.className = 'step'; dec.innerHTML = controlIcon('M3 8h10'); dec.setAttribute('aria-label', 'decrease');
      ...
      const inc = document.createElement('button'); inc.type = 'button'; inc.className = 'step'; inc.innerHTML = controlIcon('M3 8h10M8 3v10'); inc.setAttribute('aria-label', 'increase');
      stepper.append(dec, num, inc);
      const rm = document.createElement('button'); rm.type = 'button'; rm.className = 'r-remove'; rm.innerHTML = controlIcon('M4 4l8 8M12 4l-8 8'); rm.title = 'Remove this restriction'; rm.setAttribute('aria-label', 'remove restriction');
...
function controlIcon(path) {
  return `<svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="${path}"/></svg>`;
}
...
function renderSidebar() {
  ...
  for (const grp of [...primaryGroups, ...extra]) {
    ...
    const arrow = document.createElement('span'); arrow.className = 'khdr-arrow'; arrow.innerHTML = controlIcon('M3 6l5 5 5-5');
